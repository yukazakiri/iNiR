            ...
            Row {
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        ...
                        Quickshell.execDetached(["/usr/bin/qs", "-p", Quickshell.shellPath("shell.qml"), "ipc", "call", "region", "screenshot"]);
                    }
                }
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        if (RecorderStatus.isRecording) {
                            ...
                            GlobalStates.overlayOpen = false;
                            Quickshell.execDetached(["/usr/bin/qs", "-p", Quickshell.shellPath("shell.qml"), "ipc", "call", "region", "recordWithSound"]);
                        }
                    }
